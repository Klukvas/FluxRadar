 ...
 * and the sign-in dialog that opens over them.
 *
 * It renders from its props alone and owns no application state, which is why
 * it is a file of its own rather than another 350 lines inside `App.tsx`.
 */
